...
/**
 * The default arch()->preset()->php() fails when source strings mix LTR and RTL text (Persian + English).
 * To avoid this, we replicate only the checks we need from the preset.
 */
arch('php')->expect([
    'debug_zval_dump',
    'debug_backtrace',
